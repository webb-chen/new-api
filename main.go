...
func main() {
	...
	common.SysLog("Webb API " + common.Version + " started")
	...
	server.Use(gin.CustomRecovery(func(c *gin.Context, err any) {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": gin.H{
				"message": fmt.Sprintf("Panic detected, error: %v. Please submit a issue here: https://github.com/webb-chen/new-api/issues", err),
				"type":    "new_api_panic",
			},
		})
	}))
...
func InjectUmamiAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Umami webb-chen-->\n")
...
func InjectGoogleAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Google Analytics webb-chen-->\n")
	analyticsInject := []byte(analyticsInjectBuilder.String())
